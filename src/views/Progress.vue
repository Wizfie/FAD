<template>
  <section class="container px-4 py-4 mx-auto">
    ...
    <Pagination
      ...
      @updateNext="nextButton"
      @updatePrev="prevButton"
    />
  </section>
</template>
...
const nextButton = () => {
  if (currentPage.value < paginationOptions.length) {
    currentPage.value++
  }
...
const dataFad = [
  {
    ...
    'No FAD': '123',
    Item: 'mesin 1',
    'Terima FAD': '22/01/2025',
    'Terima BBM': '26/01/2025',
    Vendor: 'Mitra',
    Status: 'Open',
    Keterangan: 'Tunggu Info ',
    Durasi: '+- 4 Bulan',
  },
]
</script>
